...
**** TODO Ideensammlung                              :Dominik:Asim:Sophia:
DEADLINE: <2021-04-18 Sun 18:00>

https://www.gloomaps.com/xyXGmKY3je

**** TODO 3 Prototypen                               :Dominik:Asim:Sophia:
DEADLINE: <2021-04-19 Mon 12:00>
...
< Beschreibung der Ideensammlung (ca. 1-2 Seiten Text exklusive Bilder) >

Um eine Vielfalt an Ideen möglichst umfangreich und vollständig
abbilden zu können, ohne dabei jedoch den Überblick zu verlieren,
haben wir uns für eine Mind-Mapping-Technik entschieden. Im ersten
Schritt haben wir uns gefragt, worum es sich bei unserem Projekt
überhaupt handelt. Die Antworten darauf bildeten sozusagen die erste
Ebene unserer Mindmap. In den Folgeschritten wurde diese erste Ebene
...
Unsere Mindmap ist online abrufbar unter
https://www.gloomaps.com/xyXGmKY3je.
...
*** 3 Skizzen
- Basierend auf Ideensammlung
- von grundauf unterschiedliche und voneinander unabhängige
- https://developer.apple.com/videos/play/wwdc2017/818/)
- Konzentrieren Sie sich auf den Inhalt des Prototypen, nicht auf das
  Tool.
*** Anpassung des Prototypen an Ihre Zielgruppe
- Anpassung an Nutzeranalyse und Personas aus M1 an
- Dokumentieren Sie, welche und ob Sie Anpassungen für die jeweilige
  Zielgruppe durchgeführt haben.
** Evaluierung der Prototypen
 - 3 Interviews, in denen Sie die Prototypen diskutieren, analysieren,
   und bewerten (jeder Testuser soll alle Prototypen testen).
