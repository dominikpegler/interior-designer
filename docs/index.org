...
*** Vorschläge von Sophia
**** Sophia:
minimales Design beibehalten aber mehr Bilder und kurze
Beschreibungen, damit klar ist welche Funktionen die Button haben
**** Asim:
Anordnung von Bildern bearbeiten, auch mehr Text hinzufügen,
z. B. Überschriften für die jeweiligen Screens wie „Raum auswählen“,
Schriftzug „INTERIOR DESIGNER“ überarbeiten
**** Dominik:
Startscreen gestalterisch mehr Ausbauen, z.B. mit Hintergurndbild,
Funktion hinzufügen um gespeicherte Möbel zu kategorisieren, sortieren
oder filtern
