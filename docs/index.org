...
Navigationsabfolgen beschreiben:
  ...
  1. User startet die App, gelangt zum *HomeScreen* und findet dort 3
     große Buttons:
     1. Scan New Room
     2. My Rooms
     3. My Objects
  2. User entschließt sich zum Scannen eines neuen Raumes und tippt
     *"Scan New Room"* an.
  3. User befindet sich jetzt im *RoomScanScreen*, die Kamera des
  ...
  4. User ist nun im *RoomScanConfirmScreen* angelangt, sieht eine
  ...
  6. Im *RoomSelectScreen* wird eine Liste an Räumen angezeigt. Diese
  ...
  7. User gelangt in den *RoomScreen* und findet sich damit im gerade
  ...
  8. User ist im *ObjectSelectScreen*. Dieser Screen ähnelt dem
     ...
     zurück in den *RoomScreen* und das Objekt wird mittig im Bild
     platziert.
  9. Zuletzt kann user den Raum speichern oder abbrechen. In beiden
