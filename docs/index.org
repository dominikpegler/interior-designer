...
- Hauptfarben: ca. 4 Farben
    ...
    #+latex:\definecolor{colorA}{HTML}{99b3ff}
  - Farbe A: #99b3ff
    #+latex: \textcolor{colorA}{██████████}
    
    #+latex:\definecolor{colorB}{HTML}{ff9999}
  - Farbe B: #ff9999
    #+latex: \textcolor{colorB}{██████████}
    
    #+latex:\definecolor{colorC}{HTML}{8cd9b3}
  - Farbe C: #8cd9b3
    #+latex: \textcolor{colorC}{██████████}
    
    #+latex:\definecolor{colorD}{HTML}{d9d98c}
  - Farbe D: #d9d98c
    #+latex: \textcolor{colorD}{██████████}

#+caption: Beispiel-Components react-elements: /Solid/, /Clear/, /Outline/
#+attr_html: :width 400px 
[[file:./img/react-elements_components.png]]

Beispiel Component aus react native elements:
#+begin_src js 
