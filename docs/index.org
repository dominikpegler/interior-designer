...
Es gibt zwei Start-Screens (Abbildung ref:fig:lofi_sophia_12), zwischen die man durch wischen navigieren
...
#+caption: "Prototype #1: Screens 1 -- 2"
...
(Abbildung ref:fig:lofi_sophia_34) mit Fotos und Ideen.  Oben ist eine Slideshow
mit fertig gestalteten

#+caption: "Prototype #1: Screens 3 -- 4"
...
(Abbildung ref:fig:lofi_sophia_56).  Unter der Slideshow steht „Wohnideen“ und
...
#+caption: "Prototype #1: Screens 5 -- 6"
...
Abbildung ref:fig:lofi_asim_1 zeigt eine simple Startseite, auf der man gleich den ersten
Schritt sieht den man machen muss. Und zwar
einen Raum zum Gestalten auswählen.

#+caption: "Prototype #3: Screen 1"
#+name: fig:lofi_asim_1
#+attr_html: :height 400px
file:./img/m2_lofi_asim_1.png

Auf Abbildung ref:fig:lofi_asim_2 gibt es zwei Möglichkeiten einen Raum auszuwählen.
...
#+caption: "Prototype #3: Screen 2"
#+name: fig:lofi_asim_2
#+attr_html: :height 400px
file:./img/m2_lofi_asim_2.png

Abbildung ref:fig:lofi_asim_3: Falls man einen Raum aus den Vorhandenen
...
#+caption: "Prototype #3: Screen 3"
#+name: fig:lofi_asim_3
#+attr_html: :height 400px
file:./img/m2_lofi_asim_3.png

Nach dem ein Raum ausgewählt wurde besteht auf Abbildung ref:fig:lofi_asim_4 die
Möglichkeit Möbel zu importieren. Dies geschieht in
dem man auf das "+" Button klickt.

#+caption: "Prototype #3: Screen 4"
#+name: fig:lofi_asim_4
#+attr_html: :height 400px
file:./img/m2_lofi_asim_4.png

In Abbildung ref:fig:lofi_asim_5 kann man durch das Berühren eines
Möbelstückes dieses in den Raum importieren.

#+caption: "Prototype #3: Screen 5"
#+name: fig:lofi_asim_5
#+attr_html: :height 400px
file:./img/m2_lofi_asim_5.png

Abbildung ref:fig:lofi_asim_6: Der Schritt zum Möbel importieren wird mehrmals ausgeführt bis man
