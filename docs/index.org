...
- Die Abgabe wird erst nach 3 Tagen gesperrt, das letzte Hochladen zählt als Abgabedatum.
    ...
    - Ideensammlung: Generieren, skizzieren und diskutieren Sie ein breites Spektrum an Lösungsideen für Ihr Projekt. Benutzen Sie dazu mindestens eine dedizierte Kreativitätstechnik (basierend auf Eigenrecherche, ein guter Startpunkt ist zum Beispiel folgender [[https://de.wikipedia.org/wiki/Kreativit%C3%A4tstechniken][Wikipedia-Artikel]]; Beispiel: [[http://fds.design/][5 design sheets]]).
