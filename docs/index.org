...
**** Feedback von Person B
/Autorin: Sophia PUM/
**** Feedback von Person C
/Autor: Dominik Pegler/
...
dass es nicht ganz klar ist, wie die Abmessungen zustande kommen, wie
der Platz berechnet wird, ob die Proportionen stimmen und wie viele
Restplatz übrig bleibt, nachdem man das Möbelstück platziert hat. Hier
würde sich der Testuser ein paar Maßangaben wünschen.

Zum letzten Screen meinte der Testuser, dass nicht klar ist, wofür die
beiden Buttons (Das Plus-Symbol und das Upload-Symbol) stünden und
worin sie sich unterscheiden würden.
...
Häckchen fand der Test wieder gut. Nicht so klar war die Bedeutung des
"X" und des Häkchens am Bildschirm mit dem Satz "this your room?". Der
Tester konnte sich keine Vorstellung machen, was nun passieren würde,
