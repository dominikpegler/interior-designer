...
**** DONE Ideensammlung                                   :Dominik:Sophia:
CLOSED: [2021-04-20 Tue 12:35] DEADLINE: <2021-04-18 Sun 18:00>
...
- Rechtschreibfehler
- was bedeutet Kamera?
- was bedeutet Fotoalbum? Warum sollte ich jetzt z.B. auf Fotoalbum klicken?
  - wäre vielleicht gut mit einem Untertitel, Beschreibung
- auch sehr nüchtern, wär aber besser bunter/kreativer
- obwohl schon cool, dass es aufgeräumt ist
- vielleicht kann mans erweitern mit Pflanzen?
- Ist nicht ganz klar, warum ich da jetzt auf was klicken sollte.


- wär auch cool so eine Randomfunktion. Artikel von Geschäftspartner wird in Raum platziert.
...
**** Person C
/Autor: Dominik Pegler/
- Font zu wackelig, unsicher
- Unklar, wie die Abmessungen sind
  - wie wird das berechnet, dass es von den Proportionen her passt?
  - wichtig --> wie viel Platz bleibt frei?
- Unklar, was die beiden Buttons sind --> + und upload
- Zu nüchtern, besseres Logo, etwas, das mehr einlädt, kreativ tätig zu werden.
  - vermittelt nicht den Spaß
- Ideen Z.B. während der Ladezeit Animation wie z.B. Vorhang auf.
...
- "This your room"
- schaut frisch aus (jetzt von der farbgebung her, insgesamt)
- ist konkreter, abmessungen, einrichtungen
- "start scanning" was ist das? ist ja ein neues projekt, oder? dann
  würd ichs auch so benennen.
- oben sollte starte was Neues sein und unten die alten Projekte. Das
  fände ich intuitiver, zumindest kenne ich es nur so.
- turn around und finished mit hakerl ist gut
- ich weiß nicht, was das bedeutet --> X oder HAKERL bei "this your
  room?" screen. was passiert dann wenn ich X drücke? Muss ich dann
  selber abmessen gehen?

** Anpassung des Prototypen an Ihre Zielgruppe
*** Vorschläge Asim
**** Prototyp Asim 
2.seite mehr Beschreibung 
Kategorisierung und Suche bei Möbeln und Räumen 
Navbar verändern

**** Prototyp Dominik
Fürs scannen mehr Beschreibung 
Letzte Seite button für mehr Möbel 
Letzte Seite button für Export

**** Prototyp Sophia
Scan Seite überarbeiten
Letzte Seite an mobile anpassen 
Möbel hinzufügen klarer machen
