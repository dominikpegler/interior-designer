...
- Beruf: Verkäuferin
* Aufgabenanalyse
** \begin{center}\vskip 2.5cm \normalsize\hspace{8mm}\MakeUppercase{\insertsection}\end{center} :Bild:

#+LATEX: \begin{center}
#+LATEX: \vskip -12.7em \includegraphics[height=210px]{./img/m1_praes_ol_horse.png}
#+LATEX: \end{center}
** Aufgabeanalyse
- ...
- ...
