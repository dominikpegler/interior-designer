...
\label{sec:org9743b84}

\begin{frame}[label={sec:org394064b}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:org0d17118}]{Interior Designer App}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org592b619}]{Interior Designer App}
...
\begin{frame}[label={sec:orgb4d551c}]{Interior Designer App}
...
\label{sec:org64cff6d}
\begin{frame}[label={sec:org9c639af}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:org0e778d1}]{Literatur}
...
\begin{frame}[label={sec:orgecfc229}]{Literatur I}
...
\begin{frame}[label={sec:org9190ffd}]{Literatur II}
...
\section{Personas}
\label{sec:org1f53bc3}
\begin{frame}[label={sec:org96c2a97}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\begin{center}
\vskip -12.5em \includegraphics[height=140px]{./img/m1_praes_ol_persona3.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3c628a3}]{Personas I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9c0fd6a}]{Personas II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgeef054b}]{Personas III}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfdcff42}]{Personas IV}
...
\label{sec:orgf6f6df7}
\begin{frame}[label={sec:org56dfd57}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}
\begin{frame}[label={sec:orgd60d352}]{Aufgabenanalyse}
\begin{center}
\begin{tabular}{lcc}
\toprule
...
\label{sec:org1824efa}
\begin{frame}[label={sec:org5b9c158}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:orga4e8ea6}]{Projektmanagement I}
