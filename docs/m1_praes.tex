...
\label{sec:orgf55add0}
\begin{frame}[label={sec:org6174e96}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:org67fe796}]{Literatur}
...
\begin{frame}[label={sec:org57559cf}]{Literatur I}
...
\begin{frame}[label={sec:org0d01303}]{Literatur II}
...
\section{Personas}
\label{sec:org235eaa2}
\begin{frame}[label={sec:orgea705a6}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\begin{center}
\vskip -12.5em \includegraphics[height=140px]{./img/m1_praes_ol_persona3.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org83852b1}]{Personas I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf553b18}]{Personas II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge145dca}]{Personas III}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org388fc70}]{Personas IV}
...
\label{sec:org96fa879}
\begin{frame}[label={sec:org7ec8a8b}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}
\begin{frame}[label={sec:org4b03b67}]{Aufgabenanalyse}
\begin{center}
\begin{tabular}{lcc}
\toprule
...
\label{sec:orgc79ea8f}
\begin{frame}[label={sec:org8401bbe}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:orgd2c6e9c}]{Projektmanagement I}
