...
\label{sec:org4e417e1}

\begin{frame}[label={sec:org6f39da5}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:org7b267f2}]{Interior Designer App}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6971d1a}]{Interior Designer App}
...
\begin{frame}[label={sec:org0c06b62}]{Interior Designer App}
...
\section{Personas}
\label{sec:org286da77}
\begin{frame}[label={sec:org0daf65a}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\begin{center}
\vskip -12.5em \includegraphics[height=140px]{./img/m1_praes_ol_persona3.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org64f8aa7}]{Personas I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org98d2e7e}]{Personas II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org30c2f3d}]{Personas III}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org68e7822}]{Personas IV}
...
\label{sec:orgd76323f}
\begin{frame}[label={sec:org69cfe3c}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}
\begin{frame}[label={sec:org6df277f}]{Aufgabenanalyse}
\begin{center}
\begin{tabular}{lcc}
\toprule
...
\label{sec:orgd34e388}
\begin{frame}[label={sec:org5dc8fc0}]{\vspace{2.2cm}\begin{center}\MakeUppercase{\insertsection}\end{center}}
\end{frame}

\begin{frame}[label={sec:org1ee17a8}]{Projektmanagement I}
