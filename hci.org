...
Die Autoren nennen weiters fünf häufig verwendete Methoden von AUR:
...
Kalkulation der Position und Ausrichtung wird der virtuelle Gegenstand
platziert.
...
EINSCHRÄNKUNGEN
Die AR-Technologie wird nicht auf allen Android-Geräten in großem Umfang unterstützt. Um dieses Problem zu lösen, wurde die 8. Wand verwendet, da die 8. Wand immer noch ein sich entwickelndes Arsdk-Tool ist. Daher ist die mangelnde Genauigkeit der Anwendung zu beobachten.
Die in der Option angezeigten Möbelobjekte werden aus dem Backend importiert und lokal gespeichert. Daher gibt es keine Photogrammetrie, mit der die Anwendung das Bild in ein 3D-Objekt konvertieren kann. Die Anwendung kann den Benutzer aufgrund begrenzter Funktionen des SDK-Tools nicht in der Lage sein, zwei oder mehr Objektinstanzen auf einer einzelnen Oberfläche zu platzieren.

ERGEBNISSE
In dieser AR-Umgebung kann der Benutzer die Eigenschaften virtueller Möbel anpassen und in der realen Welt eigene Arrangements erstellen. Über die mobile Kamera kann der Benutzer die Planoberfläche erkennen, die Möbel über die Anwendung auswählen und auf dem Bildschirm platzieren. Darüber hinaus kann diese mobile Anwendung in künstliche Intelligenz integriert werden, um die Vorstellungskraft des Benutzers zu steigern und ein animiertes Erlebnis in Echtzeit zu ermöglichen. Dieses Papier konzentriert sich hauptsächlich auf die Implementierung einer immersiven Designlösung auf einer mobilen Plattform, die auf den Prinzipien von Augmented Reality (AR) basiert. Als Designlösung kann diese Anwendung dazu beitragen, die Kosten für das Prototyping zu senken und eine bessere Erfahrung für den Kunden zu simulieren. Es ermöglicht dem Kunden auch, selbst Designer zu sein und sein Zuhause so zu gestalten, wie er es möchte. Es hilft ihnen auch, ein Thema im Haus festzulegen und ein Gefühl dafür zu bekommen, bevor sie eine Bestellung aufgeben. Diese Anwendung wird sich auch für Werbezwecke als vorteilhaft für die Unternehmen erweisen. Somit kann dieses System die folgenden Mängel beseitigen:
a) Es ist schwierig, den Inhalt des Kunden zu erfüllen, um sein Zimmer ohne das tatsächliche Bild des fertigen Raums zu gestalten.
b) Kataloge bieten nicht alle möglichen Ansichten der Möbel.
c) Schwierigkeiten bei der Visualisierung des möblierten Raums.
d) Beschränkung der Anzahl der Möbel, die im Geschäft ausgestellt werden können

[[file:./tasks/literatur/Moares et al. - 2020 - Inter AR Interior decor app using augmented reali.pdf][PDF]]


*** Developing accessible mobile applications with cross-platform development frameworks (Mascetti, S., Ducci, M., Cantù, N., Pecis, P. & Ahmetovic, D. (2020)
